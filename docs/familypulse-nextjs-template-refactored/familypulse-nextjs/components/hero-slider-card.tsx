    ...
    <section className="relative overflow-hidden rounded-[1.7rem] border border-fp-line bg-fp-cream shadow-card lg:rounded-[2rem]">
      <div className="grid min-h-[430px] lg:grid-cols-[0.95fr_1.05fr]">
        <div className="relative z-10 flex flex-col justify-center px-5 py-8 sm:px-10 lg:px-14">
          <p className="mb-4 text-sm font-black text-fp-green sm:text-base">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              className="inline-flex items-center gap-3 rounded-2xl bg-fp-green px-6 py-3.5 text-sm font-black text-white shadow-green"
              href="#articles"
            >
              Explore Articles <ChevronRight className="h-5 w-5" />
            </a>
            <a
              className="inline-flex items-center gap-3 rounded-2xl border border-fp-green/20 bg-white px-6 py-3.5 text-sm font-black text-fp-ink shadow-soft"
              href="#podcast"
            >
