...
export function PodcastCTA() {
  return (
    <div className="relative overflow-hidden rounded-[1.7rem] bg-[radial-gradient(circle_at_80%_25%,rgba(126,188,98,.38),transparent_28%),linear-gradient(135deg,#063a15,#0e6b28)] p-5 text-white shadow-green sm:p-8">
      <div className="relative z-10 flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <span className="grid h-16 w-16 place-items-center rounded-3xl border border-white/20 bg-white/10">
            <Headphones className="h-9 w-9" />
          </span>
          <div>
            <h2 className="text-2xl font-black tracking-[-0.04em]">FamilyPulse Podcast</h2>
