...
const TOPICS = [
  {
    ...
    icon: "MessageCircle",
    subtopics: ["Family meetings", "Conflict repair", "Listening habits", "Digital boundaries"],
  },
  {
    title: "Parenting & Discipline",
    description: "Positive guidance that works",
    icon: "ShieldCheck",
    subtopics: ["Toddler guidance", "Teen independence", "Consequences", "Co-parenting rules"],
  },
  {
    title: "Marriage & Relationships",
    description: "Stronger together, every day",
    icon: "Heart",
    subtopics: ["Date-night rituals", "Money conversations", "Intimacy", "Repair after conflict"],
  },
  {
    title: "Work-Life Balance",
    description: "Thrive at home and work",
    icon: "BriefcaseBusiness",
    subtopics: ["Flexible schedules", "Burnout recovery", "Shared chores", "Remote-work routines"],
  },
  {
    title: "Child Development",
    description: "Support your child's growth",
    icon: "Star",
    subtopics: ["Early learning", "School readiness", "Emotional skills", "Screen time"],
  },
  {
    title: "Mental Wellness",
    description: "Calm habits for every day",
    icon: "Brain",
    subtopics: ["Family stress", "Anxiety support", "Sleep routines", "Caregiver resilience"],
  },
  {
    title: "Family Activities",
    description: "Simple ways to connect",
    icon: "PartyPopper",
    subtopics: ["Weekend plans", "Low-cost outings", "Holiday traditions", "At-home play"],
  },
  {
    title: "Faith & Values",
    description: "Shared values at home",
    icon: "Home",
    subtopics: ["Family service", "Gratitude", "Character habits", "Interfaith homes"],
  },
] as const;
