...
export function ArticleCard({ article }: { article: Article }) {
  return (
    <article data-clickable="true" className="group min-w-[245px] overflow-hidden rounded-md border border-fp-line bg-white shadow-card transition duration-300 hover:-translate-y-1 hover:shadow-xl sm:min-w-0">
