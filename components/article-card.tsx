...
export function ArticleCard({ article }: { article: Article }) {
  return (
    <a
      ...
      className="group block min-w-[245px] overflow-hidden rounded-md border border-fp-line bg-white shadow-card transition duration-300 hover:-translate-y-1 hover:shadow-xl sm:min-w-0"
    >
      <div className="relative h-36 overflow-hidden sm:h-40 lg:h-44">
        <Image
          ...
          sizes="(max-width: 640px) 245px, (max-width: 1536px) 28vw, 14vw"
        />
