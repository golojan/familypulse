...
export function PodcastEpisodeList({ episodes }: PodcastEpisodeListProps) {
  return (
    <div id="podcast" className="rounded-lg border border-fp-line bg-white p-4 shadow-card sm:p-5">
      <SectionHeader title="Latest Podcast Episodes" />
      <div className="overflow-hidden rounded-md border border-fp-line bg-white">
